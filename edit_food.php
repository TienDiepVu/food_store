...
<body>
    ...
    $sql_edit_food = "SELECT * FROM food WHERE food_id = $id";
    $result = mysqli_query($conn, $sql_edit_food);
    $row = mysqli_fetch_assoc($result);

    ?>
    <div class="container">
        <h1 class="text-center">Chỉnh sửa món ăn</h1>
        <form action="update_food.php" method="get" style="max-width: 800px; margin: auto">
            <input type="hidden" name="sid" value="<?php echo $id; ?>">
            <div class="row">
                <div class="form-group col">
                    <label for="food_id">ID</label>
                    <input type="text" class="form-control" name="food_id" disabled value=" <?php echo $row['food_id'];  ?>">
                </div>
                <div class="form-group col">
                    <label for="food_name">Món ăn</label>
                    <input type="text" class="form-control" name="food_name" value=" <?php echo $row['food_name'];  ?>">
                </div>
            </div>
            <div class="row">
                <div class="form-group col">
                ...
                <div class="form-group col">
                    ...
                    <input type="file" class="form-control" name="thumnail" value=" <?php echo $row['thumnail'];  ?>">
                </div>
            </div>
            <div class="row">
                <div class="form-group col">
